<template>
    <div>
        ...
        <div class="order-card poppins mt-5"> 
            ...
            <div v-for="(item, index) in orderItem" :key="index" class="order-item pt-5 mb-3 d-flex flex-row align-items-center">
                <div class="pic" style="width: 25%;">
                    <img src="../../../assets/product-3.png" style="height: 70px; width: 62px; border-radius: 20px;">
                </div>

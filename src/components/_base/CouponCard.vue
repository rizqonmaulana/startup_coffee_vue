...
<style scoped>
.coupon-card-parent .coupon {
  font-weight: 700;
  font-size: 33px;
}

.coupon-card-parent .btn-coupon {
  color: #fff;
...
.coupon-card-parent .btn-coupon:hover {
  color: #fff;
...
.coupon-card-parent .coupon-card {
  border-radius: 20px;
  font-family: 'Poppins', sans-serif;
  margin-left: -45px;
}

.coupon-card-parent .coupon-term-condition {
  margin-left: -45px;
}

    ...
    <div>
        <div class="card">
            <div class="d-flex flex-row align-items-center">
              <button @click="deleteOrderHistory(orderDetailId)" class="btn-del rounded-circle">X</button>
              <div class="pic" style="width: 30%">
                <img class="rounded-circle" src="../../../assets/product-1.png" width="60px">
              </div>
...
export default {
  ...
  methods: {
    deleteOrderHistory(orderDetailId) {
      axios.delete(`http://localhost:3000/order/history/${orderDetailId}`)
      .then(response => {
